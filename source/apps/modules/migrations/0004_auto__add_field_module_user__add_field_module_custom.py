...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Module.user'
        db.add_column('modules_module', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Module.custom'
        db.add_column('modules_module', 'custom',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Module.user'
        db.delete_column('modules_module', 'user_id')

        # Deleting field 'Module.custom'
        db.delete_column('modules_module', 'custom')
