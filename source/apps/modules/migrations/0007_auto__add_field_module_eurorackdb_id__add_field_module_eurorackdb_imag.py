...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Module.eurorackdb_id'
        db.add_column('modules_module', 'eurorackdb_id',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Module.eurorackdb_image'
        db.add_column('modules_module', 'eurorackdb_image',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Module.eurorackdb_id'
        db.delete_column('modules_module', 'eurorackdb_id')

        # Deleting field 'Module.eurorackdb_image'
        db.delete_column('modules_module', 'eurorackdb_image')
    ...
    models = {
        ...
        'modules.module': {
            ...
            'eurorackdb_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'eurorackdb_image': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'hp': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'manufacturer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['modules.Manufacturer']", 'null': 'True', 'blank': 'True'}),
        ...
        'modules.setup': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'preset': ('django.db.models.fields.TextField', [], {}),
