...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Module.manufacturer'
        db.alter_column('modules_module', 'manufacturer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modules.Manufacturer'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Module.manufacturer'
        raise RuntimeError("Cannot reverse this migration. 'Module.manufacturer' and its values cannot be restored.")
